(function() {
    ...
    var app = angular.module('angular-utils', ['toastr']);
    ...
    /**
     * Returns whether a given array contains a given value
     * @param Object this
     * @param mixed needle
     * @return boolean
     */
